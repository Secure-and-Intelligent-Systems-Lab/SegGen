...
from components.factory.factory import SCHEDULERS

@SCHEDULERS.register("PolyLR")
...
@SCHEDULERS.register("WarmupPolyLR")
...
@SCHEDULERS.register("WarmupExpLR")
...
@SCHEDULERS.register("WarmupCosineLR")
